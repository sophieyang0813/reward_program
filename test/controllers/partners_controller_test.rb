...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { email: @partner.email, name: @partner.name, password_digest: @partner.password_digest } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { email: @partner.email, name: @partner.name, password_digest: @partner.password_digest } }
